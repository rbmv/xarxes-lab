...
\begin{itemize}
    ...
    \item Sessió 1 - 05/03/21 (Seguiment Teams: torn 1)
    \item Sessió 2 - 12/03/21 (Seguiment Teams: torn 2).
    \item Sessió 3 - 19/03/21 (Seguiment Teams: torn 1).
    \item Sessió 4 - 26/03/21 (Seguiment Teams: torn 2).
    \item \textbf{Lliurament}: 28/03/21.
    \item Prova de validació presencial (Lab Integrat) – 09/04/2021 (Si escau)
\end{itemize}
