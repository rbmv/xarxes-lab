...
Busqueu informació a internet i contesteu a les següents preguntes:
\begin{exer} Definiu que és i quin és el proposit del protocol CSMA. Perque creieu que és especialment important en una xarxa amb un Hub? \end{exer}
